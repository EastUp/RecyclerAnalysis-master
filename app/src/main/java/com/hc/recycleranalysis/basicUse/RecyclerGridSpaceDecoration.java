...
public class RecyclerGridSpaceDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, int itemPosition,
        ...
        {
            outRect.set(0, 0, mDivisionSpace, 0);
        } else if (isLastColum(parent, itemPosition - 1, spanCount, childCount))// 如果是最后一列，则不需要绘制右边
        {
            outRect.set(0, 0, 0, mDivisionSpace);
        } else {
            outRect.set(0, 0, mDivisionSpace,
                    mDivisionSpace);
        }
    }
}
